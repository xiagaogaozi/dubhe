...
$lines = @(
    ...
    "7. 需要生成 macOS/iOS 产物时，先双击 Authorize-Dubhe-GitHub-Actions.cmd，再双击 Activate-Dubhe-GitHub-Actions.cmd。",
    "8. 最终四端交付前，运行 scripts\verify-delivery-pack.ps1 -RequireAllPlatforms，强制检查 macOS 和 iOS 产物。",
    "",
