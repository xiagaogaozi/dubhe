        ...
        if (Test-Path -LiteralPath $deliveryZipPath) {
            ...
            try {
                ...
                $requiredEntries = @(
                    ...
                    @{ label = "GitHub Actions 授权入口"; pattern = "15-Authorize-Dubhe-GitHub-Actions-This-PC.cmd" },
                    @{ label = "GitHub Actions 激活入口"; pattern = "16-Activate-Dubhe-GitHub-Actions-This-PC.cmd" },
