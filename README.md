...
- [Dubhe Core](services/core/README.md)：FastAPI 后端最小骨架，包含本地账号登录、设备同步、新闻分析、策略草案、回测、风控审批、kill switch、纸面订单和模拟券商回报。
- [Dubhe Desktop](apps/desktop/README.md)：React + Vite 中文桌面工作台前端雏形，包含本地登录页、类 IDE 研究工作区、实时同步、审批/急停面板和纸面交易展示。
