...
- [Dubhe Companion](apps/mobile/README.md)：Flutter iOS/Android 移动端源码骨架，包含本地账号登录、新闻雷达、中文 AI 影响分析、纸面组合和审批操作入口；当前已生成 Android/iOS 平台工程并通过本地 `flutter analyze` / `flutter test`。
