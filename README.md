...
- [Dubhe Core](services/core/README.md)：FastAPI 后端最小骨架，包含健康检查、中文新闻分析占位、策略规格校验、风控门禁和纸面订单占位链路。
- [Dubhe Desktop](apps/desktop/README.md)：React + Vite 中文桌面工作台前端雏形，接入 Core API。
