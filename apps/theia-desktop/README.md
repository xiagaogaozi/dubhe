...
- 当前主视图已经接入 Dubhe Core：可配置 Core 地址、检查健康状态、创建/登录本地账号、刷新新闻源、触发中文分析、生成策略草案、运行 deterministic replay 回测、提交纸面交易、读取纸面组合、生成实盘审批演示、查看待审批请求、通过/拒绝审批，并切换 kill switch。
...
6. 风控中心：继续补齐审计日志浏览、审批筛选、实时同步和更完整的风控策略配置。
